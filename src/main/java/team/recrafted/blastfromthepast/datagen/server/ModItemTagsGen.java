...
public class ModItemTagsGen extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(ModTags.Items.PSYCHO_BEAR_FOOD)
                .add(ModBlocks.BEAST_CHOPS_GLAZED.get().asItem());
        ...
        tag(ItemTags.STONE_TOOL_MATERIALS).add(ModBlocks.PERMAFROST.COBBLESTONE.get().asItem());

        tag(ModTags.Items.PERMAFROST_PAINTING)
                .add(ModBlocks.PERMAFROST_BURREL_PAINTING.get().asItem()).
                add(ModBlocks.PERMAFROST_SNOWDO_PAINTING.get().asItem()).
                add(ModBlocks.PERMAFROST_GLACEROS_PAINTING.get().asItem()).
                add(ModBlocks.PERMAFROST_PSYCHO_BEAR_PAINTING.get().asItem()).
                add(ModBlocks.PERMAFROST_SPEARTOOTH_PAINTING.get().asItem()).
                add(ModBlocks.PERMAFROST_FROSTOMPER_PAINTING_TOP_RIGHT.get().asItem()).
                add(ModBlocks.PERMAFROST_FROSTOMPER_PAINTING_TOP_LEFT.get().asItem()).
                add(ModBlocks.PERMAFROST_FROSTOMPER_PAINTING_BOTTOM_RIGHT.get().asItem()).
                add(ModBlocks.PERMAFROST_FROSTOMPER_PAINTING_BOTTOM_LEFT.get().asItem());

        this.tag(ItemTags.MUSIC_DISCS)
                .add(ModItems.BLIZZARD_REVELRY_DISC.get());
    }
}
