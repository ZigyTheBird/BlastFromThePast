...
public class ModRecipesGen extends RecipeProvider {
    ...
    private void stoneGroup(RecipeOutput pRecipeOutput, BFTPStoneGroup group) {
        ...
        stairBuilder(group.POLISHED_STAIRS, Ingredient.of(group.POLISHED)).unlockedBy(getHasName(group.BLOCK), has(group.BLOCK)).save(pRecipeOutput);
        slab(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, group.POLISHED_SLAB, group.POLISHED);
        wall(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, group.POLISHED_WALL, group.POLISHED);
        stairBuilder(group.COBBLESTONE_STAIRS, Ingredient.of(group.COBBLESTONE)).unlockedBy(getHasName(group.BLOCK), has(group.BLOCK)).save(pRecipeOutput);
        slab(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, group.COBBLESTONE_SLAB, group.COBBLESTONE);
        wall(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, group.COBBLESTONE_WALL, group.COBBLESTONE);
        stairBuilder(group.BRICKS_STAIRS, Ingredient.of(group.BRICKS)).unlockedBy(getHasName(group.BLOCK), has(group.BLOCK)).save(pRecipeOutput);
        slab(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, group.BRICKS_SLAB, group.BRICKS);
        wall(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, group.BRICKS_WALL, group.BRICKS);
        chiseled(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, group.CHISELED_BRICKS, group.BLOCK);
    }
