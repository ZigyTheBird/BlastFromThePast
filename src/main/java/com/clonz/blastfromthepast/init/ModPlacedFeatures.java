...
public class ModPlacedFeatures {
    ...
    public static void register(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, CHILLY_MOSS, chillyMossConfigured, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
